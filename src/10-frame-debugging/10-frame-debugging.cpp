...
NS::Menu* MyAppDelegate::createMenuBar()
{
    ...
    // Capture Menu UI
    NS::MenuItem* captureMenuItem = NS::MenuItem::alloc()->init();
    NS::Menu* captureMenu = NS::Menu::alloc()->init(NS::String::string("Capture", UTF8StringEncoding));

    SEL beginCaptureCb = NS::MenuItem::registerActionCallback("beginCapture", [](void*, SEL, const NS::Object*) {
        Renderer::beginCapture = true;
    });

    NS::MenuItem* pBeginCaptureItem = captureMenu->addItem(NS::String::string("Begin Capture", UTF8StringEncoding), beginCaptureCb, NS::String::string("c", UTF8StringEncoding));
...
void MyAppDelegate::applicationDidFinishLaunching(NS::Notification* notification)
{
    ...
    m_window->setTitle(NS::String::string("10 - Programmatic GPU Capture", NS::StringEncoding::UTF8StringEncoding));
...
void Renderer::buildTextures()
{
    ...
    textureDescriptor->setWidth(kTextureWidth);
    textureDescriptor->setHeight(kTextureHeight);
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        ...
        NS::String* openCmd = NS::MakeConstantString("open ")->stringByAppendingString(m_traceSaveFilePath);
